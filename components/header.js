          ...
          <nav
            ...
            {tabs.map((tab, idx) => (
              <Link
                ...
                <a
                  key={tab.name}
                  className={classNames(tab.current ? "border-teal-500 text-teal-600" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300", "w-1/6 py-4 px-1 text-center border-b-2 font-medium text-sm")}
